...
1. Inheritance (Parent child relationship within class)
2. Encapsulation (Data hiding)
3. Abstraction (information hiding)
4. Polymorphism (One method with different implementations)
-------------------------------------------------------------------
...
s = Suzuki()
s.stop()
# using above . operator we can check members accessible to a child object
----------------------------------------------------------------------
...
# super():
    - it gives u can access to members of parent in child
    - Super only active inside a method
-------------------------------------------------------------------
...
class ClassTeacher(HoD):
    def authority(self):
        # super().authority()
        super(ClassTeacher, self).authority()
        super().file()
        print('Teacher')
        print(super().x)
